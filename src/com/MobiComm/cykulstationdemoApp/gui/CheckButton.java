package com.MobiComm.cykulstationdemoApp.gui;
...
import com.MobiComm.cykulstationdemoApp.R;
...
public class CheckButton extends View {
    ...
    public CheckButton(Context context, AttributeSet attrs){
        ...
        try{
            ...
            mBackgroundDrawable = a.getDrawable(R.styleable.CheckButton_background_drawable);
