...
//        view = inflater.inflate(R.layout.device_list,mainLayout, false);
//        populateList();
...
//    }
    ...
    private void scanLeDevice(final boolean enable) {
        ...
        if (enable) {
            ...
            mScanning = true;
            mBluetoothAdapter.startLeScan(mLeScanCallback);  // Scan all devices !
//            mBluetoothAdapter.startLeScan(eRLBikeLockService.ERL_SERVICE_UUID_ARRAY, mLeScanCallback); // Scan only the eRL Devices !
